...
(function(){
  ...
  Template.loginForm.events({
    'submit #login-form' : function(e, t) {
      e.preventDefault();
      var email = trimInput(t.find('#login-email').value.toLowerCase()), password = t.find('#login-password').value;
  ...
  Template.createAccountForm.events({
    ...
    'submit #register-form' : function(e, t) {
      var email = trimInput(t.find('#account-email').value.toLowerCase()), password = t.find('#account-password').value;

      if (isNotEmpty(email, 'accountError') && isNotEmpty(password, 'accountError') && isEmail(email, 'accountError') && isValidPassword(password, 'accountError')) {
